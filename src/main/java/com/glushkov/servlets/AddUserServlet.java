...
public class AddUserServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) {
        ...
        userMap.put("firstName", request.getParameter("name"));
        userMap.put("secondName", request.getParameter("surname"));
        userMap.put("salary", request.getParameter("salary"));
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy/MM/d");
        userMap.put("dateOfBirth", LocalDate.parse(request.getParameter("date_of_birth"), formatter));
